...
public class GuiadaHNormalCuatro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_guiada_hnormal_cuatro);
    ...
    public void oyente_imgbtnantHNormal4 (View v){
